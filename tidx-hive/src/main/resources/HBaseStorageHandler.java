...
public class HBaseStorageHandler extends DefaultStorageHandler
    ...
    public void configureTableJobProperties(
        ...
        jobProperties.put(HBaseSerDe.TX_HIVE_TIME_COL,
                tableProperties.getProperty(HBaseSerDe.TX_HIVE_TIME_COL));
        jobProperties.put(HBaseSerDe.TX_HIVE_PHOENIX_INDEX_ID,
                tableProperties.getProperty(HBaseSerDe.TX_HIVE_PHOENIX_INDEX_ID));
        String txTimeCheck = tableProperties.getProperty(HBaseSerDe.TX_HIVE_TIME_CHECK);
        if (txTimeCheck != null) {
            jobProperties.put(HBaseSerDe.TX_HIVE_TIME_CHECK, txTimeCheck);
        }
